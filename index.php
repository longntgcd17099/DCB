...
<body>
	<div class="banner">
	  ...
	  <div class="header_bottom">
	   <div class="logo">
		  <h1><a href="index-2.html"><span class="m_1">W</span>atches</a></h1>
	   </div>
   	   <div class="menu">
	     <ul class="megamenu skyblue">
			...
			<li><a class="color4" href="#">womens</a>
				...
				<li class="active grid"><a class="color3" href="index-2.html">Sale</a></li>
   ...
   <div class="footer">
	    ...
	    <div class="clearfix"></div>
	    <div class="copy">
           <p> &copy; 2015 Watches. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank">LONGLONG</a></p>
	    </div>
   	</div>
   </div>
</body>
